...
var menu_state = {
	...
	preload: function() {
		...
		this.game.load.spritesheet('bird_ani', 'assets/birdsheet.png', 34, 24);
...
var main_state = {
	...
	//BIRD
		...
		//add bird to screen
		this.bird = this.game.add.sprite(bird_xStartPosition, bird_yStartPosition, 'bird_ani');
	...
	//SOUND
		this.flap_sound = this.game.add.audio('flap');
